            ...
            <div class="col-lg-4 side-left">
              <div class="card mb-4">
                <div class="card-body avatar">
                  ...
                  <a class="email" href="#">admin@demo.com</a>
                  {{-- <a class="email" href="#">{{$result->email}}</a> --}}
                  <a class="number" href="#">0175-------26524</a>
              ...
              <div class="card mb-4">
                <div class="card-body overview">
                  ...
                  <div class="wrapper about-user">
                    ...
                    <p>Hi,</p>
                    <p>I'm Mahfuz graduated from DIU in 2018 with a cgpa 3.75. I'm mostly interested in web application development.</p>
                    <p>Thanks</p>
                  </div>
