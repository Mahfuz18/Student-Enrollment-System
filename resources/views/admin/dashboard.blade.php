...
@section('content')
  ...
  <div class="col-sm-6 col-md-3 grid-margin text-center">
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <h1 class="card-title" style="font-size: 50px;" >{{$num1}}</h1>
      </div>
      <div class="dashboard-chart-card-container text-center">
  ...
  <div class="col-sm-6 col-md-3 grid-margin text-center">
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <h1 class="card-title" style="font-size: 50px;" >{{$num2}}</h1>
      </div>
      <div class="dashboard-chart-card-container text-center">
  ...
  <div class="col-sm-6 col-md-3 grid-margin text-center">
    <div class="card">
      <div class="card-body">
        <h2 class="card-title">Total Tution Fee</h2>
        <hr>
        <h1 class="card-title" style="font-size: 50px;" >20,00,000</h1>
      </div>
      <div class="dashboard-chart-card-container text-center">
  ...
  <div class="col-sm-6 col-md-3 grid-margin text-center">
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <h1 class="card-title" style="font-size: 50px;" >5,00,000</h1>
      </div>
