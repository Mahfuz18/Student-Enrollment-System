  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        ...
        {{-- Brand logo --}}
        <a class="navbar-brand brand-logo" href="index.html"><img src="images/" alt="Admin"></a>
      </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/a_dashboard')}}">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#TeacherSubmenu" aria-expanded="false" aria-controls="layoutsSubmenu">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/csedepartment')}}">
                <i class="mdi mdi-puzzle menu-icon"></i>
                <span class="menu-title">EEE Course Teachers</span>
              </a>
            </li>
            <!--main pages end-->
